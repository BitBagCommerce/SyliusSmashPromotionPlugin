...
namespace Tests\BitBag\SyliusSmashPromotionPlugin\Behat\Context\Ui\Shop;

use Behat\Behat\Context\Context;
use Tests\BitBag\SyliusSmashPromotionPlugin\Behat\Page\Shop\WelcomePageInterface;
